...
### Team Member Mapping
The persona system integrates with the software engineering team agents in `~/.claude/agents/`:

**Persona to Team Agent Mapping**:
- **architect** → Tech Lead agent (system design, architecture)
- **frontend** → Frontend Engineer agent (UI/UX implementation)
- **backend** → Backend Engineer agent (server-side development)
- **security** → Security Engineer agent (security audits, compliance)
- **performance** → Performance Engineer agent (optimization, monitoring)
- **qa** → QA Engineer agent (testing, quality assurance)
- **devops** → DevOps Engineer agent (infrastructure, deployment)
- **scribe** → Product Manager agent (documentation, requirements)
- **analyzer** → Cross-team collaboration (investigation, analysis)
- **refactorer** → Cross-team code quality
- **mentor** → Cross-team knowledge sharing

**New Agent Mappings**:
- **analyzer** → Data Engineer agent (data analysis, ETL)
- **performance** → ML/AI Engineer agent (model optimization)
- **frontend** → Mobile Engineer agent (mobile UI/UX)
- **backend** → Database Administrator agent (database backend)
- **frontend** → UX Designer agent (design systems)
- **devops** → Infrastructure/Platform Engineer agent (platform development)
- **scribe** → Documentation Engineer agent (technical writing)
- **frontend** → Accessibility Specialist agent (accessible UI)
- **devops** → Release Manager agent (deployment coordination)
- **security** → Compliance/Legal Tech agent (regulatory compliance)

**High-Priority Agent Mappings**:
- **analyzer** → Business Analyst agent (requirements analysis)
- **architect** → Solutions Architect agent (enterprise architecture)
- **devops** → Observability Engineer agent (monitoring/SRE)
- **architect** → API Designer agent (API architecture)
- **performance** → Cost Engineer agent (cost optimization)

### Team Agent Activation
When team agents are invoked through `/team` commands:
1. Load agent-specific context from `~/.claude/agents/[role].md`
2. Activate corresponding persona with enhanced capabilities
3. Apply team workflows (TDD, spec-driven, handoffs)
4. Enable team coordination and handoff protocols
